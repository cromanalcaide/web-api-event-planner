...
export const Description = () => {
    ...
    <section className="vh-100 bg">    
        <div className="descript-cont row justify-content-around mx-5">
            <div className="col-sm-2">
                <div className="text-center mb-3" style={{width: 14 + "rem"}}>
                    <img src={image1} class="card-img-top" alt="..." style={{width: 8 + "rem"}}/>
            ...
            <div className="col-sm-2">
                <div className="text-center mb-3" style={{width: 14 + "rem"}}>
                    <img src={image2} class="card-img-top" alt="..." style={{width: 7 + "rem"}}/>
                    <div className="card-body">
            ...
            <div className="col-sm-2 ">
                <div className="text-center mb-3" style={{width: 14 + "rem"}}>
                    <img src={image3} class="card-img-top" alt="..." style={{width: 8.5 + "rem"}}/>
                    <div className="card-body">
                        <h5 className="card-title">Deja mensajes a tus invitados</h5>
                        <p className="card-text">Dentro de tu evento podrás dejar comentarios a tus invitados y ellos podrán responderte!</p>
                    </div>
                </div>
            </div>
            <div className="col-sm-2">
                <div className="text-center mb-3" style={{width: 14 + "rem"}}>
                    <img src={image4} class="card-img-top" alt="..." style={{width: 7 + "rem"}}/>
                    <div className="card-body">
            ...
            <div className="lc-block d-grid gap-2 d-md-flex justify-content-md-center">
                 <Link to="/register">
                    <button type="button" className="start-btn btn btn-primary btn-lg px-4 mt-2 mb-5">Comienza ahora <i class="fa-solid fa-arrow-right"></i></button>
                </Link>
            </div>
        </div> 
    </section>   
